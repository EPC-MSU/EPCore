...
from ctypes import (Array, byref, c_char_p, c_float, c_int, c_short, c_size_t, c_ubyte,
                    c_uint, c_ushort, c_void_p, c_wchar_p, cast, CDLL, CFUNCTYPE,
...
urpc_builder_version_minor = 7
urpc_builder_version_bugfix = 2
urpc_builder_version_suffix = ""
urpc_builder_version = "0.7.2"
_Ok = 0
_Error = -1
_NotImplemented = -2
_ValueError = -3
...
class IvmDeviceHandle:
    ...
    def get_measurement_raw(self, *args, **kwargs) -> GetMeasurementRawResponse:
        src_buffer = None
        ...
        _validate_call(_lib.ivm_get_measurement_raw(self._handle, byref(src_buffer),
                                                    byref(dst_buffer)))
        return dst_buffer
    ...
    def set_measurement_settings(self, *args) -> None:
        src_buffer = None
