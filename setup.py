...
setup(
    ...
    package_data={
        "epcore.ivmeasurer": ["ivm02/ivm-debian/libivm.so",
                              ...
                              "asa10/libasa-debian/libxmlrpc.so",
                              "asa10/libasa-debian/libxmlrpc.so.3",
                              "asa10/libasa-debian/libxmlrpc.so.3.51",
                              "asa10/libasa-debian/libxmlrpc_client.so",
                              "asa10/libasa-debian/libxmlrpc_client.so.3",
                              "asa10/libasa-debian/libxmlrpc_client.so.3.51",
                              "asa10/libasa-debian/libxmlrpc_util.so",
                              "asa10/libasa-debian/libxmlrpc_util.so.4",
                              "asa10/libasa-debian/libxmlrpc_util.so.4.51",
                              "asa10/libasa-debian/libxmlrpc_xmlparse.so",
                              "asa10/libasa-debian/libxmlrpc_xmlparse.so.3",
                              "asa10/libasa-debian/libxmlrpc_xmlparse.so.3.51",
                              "asa10/libasa-debian/libxmlrpc_xmltok.so",
                              "asa10/libasa-debian/libxmlrpc_xmltok.so.3",
